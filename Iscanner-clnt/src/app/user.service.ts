...
export class UserService {
  ...
  tempupdate(sensorreading, passportid) {
    let body = new FormData();
    body.append('sensorreading', sensorreading);//passenger temperature
    body.append('passportid', passportid);//passenger temperature
    return this.http.post('/api/updatetem', body, { responseType: 'text' });

  }
  arduinogetdata() {
    return this.http.post('/api/arduino', { responseType: 'json' });
